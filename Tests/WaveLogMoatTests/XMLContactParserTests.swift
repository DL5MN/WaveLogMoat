...
final class XMLContactParserTests: XCTestCase {
    ...
    func testParseSupportsMultipleTimestampFormats() throws {
        let n1mm = "<contactinfo><call>W1AW</call><timestamp>2024-01-10 12:00:00</timestamp></contactinfo>"
        let dxlog = "<contactinfo><call>W1AW</call><timestamp>2024-01-10T12:00:00.000Z</timestamp></contactinfo>"
        let iso = "<contactinfo><call>W1AW</call><timestamp>2024-01-10T12:00:00Z</timestamp></contactinfo>"
