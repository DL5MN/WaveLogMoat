...
final class QDataStreamReaderTests: XCTestCase {
    ...
    func testReadUInt64() throws {
        var data = Data()
        data.appendUInt64(0x1122334455667788)

        let reader = QDataStreamReader(data: data)
        XCTAssertEqual(try reader.readUInt64(), 0x1122334455667788)
        XCTAssertEqual(reader.bytesRemaining, 0)
    }
    ...
    func testParseQSOLoggedMessage() throws {
        ...
        payload.appendQDateTime(julianDay: 2_460_711, millisecondsSinceMidnight: 45_610_000, timeSpec: 1)
        ...
        payload.appendQDateTime(julianDay: 2_460_711, millisecondsSinceMidnight: 45_600_000, timeSpec: 1)
