...
| 34  | Wavelog 2.4 compatibility | No breaking API changes. New `logbook_get_worked_grids` endpoint returns Maidenhead grids worked per logbook/band — useful for Phase 2 grid goals and Phase 3 grid map. Added to ROADMAP API Dependencies. | 2026-03-31 |
